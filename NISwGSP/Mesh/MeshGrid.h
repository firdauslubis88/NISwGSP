...
public:
    ...
    InterpolateVertex getInterpolateVertex(const cv::Point_<float> & _p) const;
    InterpolateVertex getInterpolateVertex(const cv::Point_<double> & _p) const;
    
    template <typename T>
    InterpolateVertex getInterpolateVertexTemplate(const cv::Point_<T> & _p) const;
private:
